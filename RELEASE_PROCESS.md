...
```sh
gowheels pypi --package-name agentic_dev_harness --name agentic_dev_harness --repo StevenACoffman/agentic-dev-harness
```
...
gowheels pypi --name agentic_dev_harness --package-name agentic_dev_harness --repo StevenACoffman/agentic-dev-harness --upload
```
...
```sh
gowheels pypi --name agentic_dev_harness --package-name agentic_dev_harness --repo StevenACoffman/agentic-dev-harness --version v0.1.0 --upload
```
